                ...
                <div className={styles.title}>
                    ...
                    <div className={styles.info}>
                        <div className={styles.myIcon}>
                            <img className={styles.avatar} src={`${BASE_URL}${avatar}`} alt=""/>
                        </div>
                        <div className={styles.user}>
                            ...
                            </div>) : (<div className={styles.edit}>
                                <Button onClick={() => this.props.history.push('/login')} inline type="primary" size="small">去登录</Button>
                            </div>)}
                        </div>
                    </div>
                </div>
